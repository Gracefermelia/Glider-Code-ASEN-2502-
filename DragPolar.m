...
if Plot_DragPolar_Data == 1
    ...
    for n=1:Count
        ...
        legend({
            ...
            sprintf('Aircraft Drag Polar- %s', OswaldModel_Names.OswaldModel2(n)), 
    ...
    for n = 1:Count
        ...
        xlabel('Coefficient of Lift (CL)');
        ylabel('Coefficient of Drag (CD)');
        title('Design Aircraft Drag Polar Configuration Comparison -', OswaldModel_Names.OswaldModel2(n));
        grid on
        hold off
    end
    legend(Design_Input.Config(:),'Location','northwest');
